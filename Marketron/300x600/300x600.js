...
}).prototype = getMCSymbolPrototype(lib.logo_1, new cjs.Rectangle(-80,-300,300,600), null);
...
p.nominalBounds = new cjs.Rectangle(2,-7,1502,652);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(129.6,467.1,1.3044,1.3044,0,0,0,73.7,73.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({alpha:1},19).to({x:-163},105,cjs.Ease.get(0.5)).wait(56));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-705,220,2209,424);
// library properties:
lib.properties = {
