...
}).prototype = getMCSymbolPrototype(lib.text1_1, new cjs.Rectangle(-80,-300,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.logo_1, new cjs.Rectangle(-80,-300,728,90), null);
...
}).prototype = getMCSymbolPrototype(lib.cta_1, new cjs.Rectangle(-80,-300,728,90), null);
...
p.nominalBounds = new cjs.Rectangle(0,-324,1360,592);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#000000").ss(1,2,1).p("Eg43gHBMBxvAAAIAAODMhxvAAAg");
	...
	this.instance_3.setTransform(314.1,62.5,0.8231,0.8231,0,0,0,73.6,73.5);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({alpha:1,mode:"synched"},19,cjs.Ease.get(0.5)).wait(40).to({startPosition:0},0).to({x:535.6,mode:"single"},49,cjs.Ease.get(0.5)).to({startPosition:0},16,cjs.Ease.get(0.5)).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({alpha:1},19,cjs.Ease.get(1)).to({x:119},105,cjs.Ease.get(0.5)).wait(56));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-211,-280,1571,547);
// library properties:
lib.properties = {
